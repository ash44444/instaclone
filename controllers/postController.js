...
module.exports.createPost = async (req, res, next) => {
  ...
  try {
    // ✅ Moderation disabled — no API call or rating check
  ...
  try {
    ...
    if (!followersDocument || followersDocument.length === 0) return;
    ...
    console.log('Error sending real-time post to followers:', err);
  }
};
